...
export const productionAdvancedRouter = router({
  analyzeShortage: requirePermission('mfg:process:manage')
  ...
  optimizeRequisition: requirePermission('mfg:process:manage')
  ...
  analyzeException: requirePermission('mfg:process:manage')
  ...
  generateDailyReport: requirePermission('mfg:process:manage')
