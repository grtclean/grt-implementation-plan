...
const clientsRouter = router({
  list: publicProcedure.input(z.object({ search: z.string().optional(), tier: z.string().optional(), page: z.number().optional(), pageSize: z.number().optional() }).optional().default({})).query(({ input }) => svc.listClients(input)),
...
const equipmentsRouter = router({
  list: publicProcedure.input(z.object({ clientId: z.number().optional(), search: z.string().optional(), operationalStatus: z.string().optional(), status: z.string().optional(), page: z.number().optional(), pageSize: z.number().optional() }).optional().default({})).query(({ input }) => svc.listEquipments(input)),
  getById: publicProcedure.input(z.object({ id: z.number() })).query(({ input }) => svc.getEquipmentById(input.id)),
  getDueSoon: publicProcedure.input(z.object({ daysAhead: z.number().optional().default(30) })).query(({ input }) => svc.getEquipmentsDueSoon(input.daysAhead)),
...
const serviceLogsRouter = router({
  list: publicProcedure.input(z.object({ clientId: z.number().optional(), equipmentId: z.number().optional(), status: z.string().optional(), priority: z.string().optional(), search: z.string().optional(), page: z.number().optional(), pageSize: z.number().optional() }).optional().default({})).query(({ input }) => svc.listServiceLogs(input)),
...
const attachmentsRouter = router({
  list: publicProcedure.input(z.object({ serviceLogId: z.number() })).query(({ input }) => svc.listAttachments(input.serviceLogId)),
...
const signatureRouter = router({
  getPendingLogs: publicProcedure.query(() => svc.getPendingSignatureLogs()),
...
const afterSalesSchedulerRouter = router({
  getStatus: publicProcedure.query(() => svc.getSchedulerStatus()),
  getHistory: publicProcedure.input(z.object({ limit: z.number().optional() }).optional().default({})).query(({ input }) => svc.getSchedulerHistory(input)),
...
const reminderRouter = router({
  previewWeChatMessage: publicProcedure.input(z.object({ daysAhead: z.number().optional().default(30) })).query(({ input }) => svc.previewWeChatMessage(input.daysAhead)),
