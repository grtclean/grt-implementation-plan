...
function getMockMessages(): GraphMailMessage[] {
  ...
  return [
    ...
    },
    {
      ...
      body: { contentType: "HTML", content: "<p>质量经理，</p><p>客诉CQ-2026-089的8D报告已完成，请审批：</p><p><b>问题描述：</b>产品表面划痕超标<br/><b>根本原因：</b>包装缓冲材料老化<br/><b>纠正措施：</b>更换EPE缓冲材料，增加包装检验工位</p><p>客户要求本周五前回复。</p><p>品管部 钱佳奇</p>" },
      from: { emailAddress: { name: "钱佳奇", address: "qian.sh@grt-group.com" } },
      toRecipients: [{ emailAddress: { name: "我", address: "me@grt-group.com" } }],
