...
/**
 * Excel 工序编号 → T 编码映射 (来自生产部真实工时台账)
 * Excel: 5.2~5.7=制造, 6.1~6.5=调试验收, 7.1~7.2=现场服务
 */
export const EXCEL_PROCESS_TO_T: Record<string, string[]> = {
  "5.2": ["T2"],              // 激光切割 → 冷作
  "5.3": ["T1"],              // 机加工 → 机加工
  "5.4": ["T2"],              // 剪板折弯 → 冷作
  "5.5": ["T3"],              // 部件制作 → 机械部件装配
  ...
  "6.2": ["T8"],              // 设备联调及跑合 → 跑和
  "6.3": ["T15"],             // 内部验收 → 终验收(内部)
  "6.4": ["T8", "T15"],       // 预验收及整改 → 跑和/终验收
  "6.5": ["T9", "T10"],       // 打包发货 → 包装+发货
  "7.1": ["T11", "T12", "T13"], // 客户现场安装 → 卸车+就位+水电气
 ...
 * 来源: 36个GRT项目历史数据回归分析
 */
export const PROCESS_CALIBRATION_FACTORS: Record<string, number> = {
  "5.2": 0.802,   // 激光切割: 偏保守，可下调
  "5.3": 1.110,   // 机加工: 基本准确，略上浮
  "5.4": 1.163,   // 剪板折弯: 上浮16%
  "5.5": 0.721,   // 部件制作: 大幅偏高，下调28%
  "5.6": 2.045,   // 机械装配: 严重低估! ×2.0
  "5.7": 1.207,   // 电气装配: 上浮21%
  "6.1": 1.234,   // 对点手动运行: 上浮23%
  "6.2": 4.067,   // 设备联调跑合: 最大超支项! ×4.0
  "6.3": 0.250,   // 内部验收: 实际极少
  "6.4": 2.807,   // 预验收整改: ×2.8
  "6.5": 1.875,   // 打包发货: ×1.9
  "7.1": 1.864,   // 现场安装: ×1.9
