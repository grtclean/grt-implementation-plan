...
**Title:** UI界面需要参照微软风格设定更新
**Scope:** General
**Stage:** PROD
**Priority:** P1
**Categories:** Frontend, Backend
**Rules:** Response < 500ms
**Generated:** 2026-03-02T13:10:45.639Z

---

## Instruction for Claude

Please analyze the codebase related to the scope "General" and implement the following:
...
```
data/dev-queue/questions/task_35.json
```
Format:
```json
{
...
```
data/dev-queue/answers/task_35.txt
```
