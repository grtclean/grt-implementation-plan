...
async function main() {
  ...
  try {
    ...
    const leads = [
      ...
      { companyName: "南京依维柯", contactName: "李娜", contactPhone: "13200132005", contactEmail: "lina@iveco-nj.com", source: "direct", productInterest: "商用车排放检测设备", estimatedBudget: "5500000.00", priority: "medium", status: "new", aiConfidence: "0.5500", assignedTo: uid(1), notes: "南京依维柯商用车基地" },
