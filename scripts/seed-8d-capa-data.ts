    ...
    // -----------------------------------------------------------------------
    {
      const res = await client.query(
        ...
        [
          ...
          userId1, JSON.stringify(['张腾飞', '杜显文', '李兴伟']),
    ...
    // -----------------------------------------------------------------------
    {
      const res = await client.query(
        ...
        [
          ...
          userId2, JSON.stringify(['马林山', '曹庆伟', '侯德朋']),
    ...
    // -----------------------------------------------------------------------
    {
      ...
      const res = await client.query(
        ...
        [
          ...
          userId3, JSON.stringify(['李兴伟', '张腾飞', '肖博雅', '张松松']),
          ...
          '感谢李兴伟带领团队在5天内完成根因分析和方案验证，张腾飞在现场连续值守3天保障生产',
    ...
    // -----------------------------------------------------------------------
    {
      const res = await client.query(
        ...
        [
          ...
          userId4, JSON.stringify(['杜显文', '侯德朋']),
    ...
    // -----------------------------------------------------------------------
    {
      const res = await client.query(
        ...
        [
          ...
          userId2, JSON.stringify(['曹庆伟', '李兴伟', '马林山']),
