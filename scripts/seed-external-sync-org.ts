/**
 * 外部平台组织架构导入脚本
 * ExternalSync Org Migration Script
 *
 * 功能:
 * 1. 检查 data/external_sync_org.csv 是否存在，不存在则自动生成GRT真实组织架构
 * 2. 解析CSV数据
 * 3. 创建 departments 表 (IF NOT EXISTS)
 * 4. 插入部门层级数据
 * 5. 插入/更新员工数据到 company_employees 表
 *
 * 用法: npx tsx scripts/seed-external-sync-org.ts
 */
...
const CSV_PATH = path.join(PROJECT_ROOT, "data", "external_sync_org.csv");
...
// ---------------------------------------------------------------------------
const EMPLOYEES = [
  { employeeId: "GRT001", name: "倪亚东",  department: "总裁办",     position: "董事长",           email: "yadong.ni@gerrytech.com",    phone: "" },
  { employeeId: "GRT080", name: "刘奥运",  department: "AI数智部",   position: "董事长助理",       email: "kaiyun.liu@gerrytech.com",   phone: "" },
  { employeeId: "GRT002", name: "黄晓兰",  department: "财务部",     position: "会计",             email: "xiaolan.huang@gerrytech.com", phone: "" },
  ...
  { employeeId: "GRT100", name: "田炜钰",  department: "人事行政部", position: "行政助理",         email: "taohong.tian@gerrytech.com",  phone: "" },
  { employeeId: "GRT049", name: "胡杨",    department: "AI数智部",   position: "IT工程师",         email: "wei.hu@gerrytech.com",        phone: "" },
  { employeeId: "GRT062", name: "朱宇浩",  department: "事业二部",   position: "生产工程师兼项目及IT工程师", email: "yuhao.zhu@gerrytech.com",     phone: "" },

  { employeeId: "GRT083", name: "刘坤",    department: "AI数智部",   position: "销售与项目工程师", email: "kun.liu@gerrytech.com",        phone: "" },
  { employeeId: "GRT103", name: "朱文韬",  department: "AI数智部",   position: "市场专员",         email: "wendong.zhu@gerrytech.com",   phone: "" },
  ...
  { employeeId: "GRT063", name: "刘健康",  department: "事业一部",   position: "销售经理",         email: "jiankang.liu@gerrytech.com",  phone: "" },
  { employeeId: "GRT006", name: "洪香龙",  department: "事业二部",   position: "机械设计经理",     email: "xilong.hong@gerrytech.com",   phone: "" },
  { employeeId: "GRT044", name: "洪小东",  department: "事业二部",   position: "机械研发工程师",   email: "xiaodong.hong@gerrytech.com", phone: "" },
  { employeeId: "GRT097", name: "钱佳奇",  department: "事业二部",   position: "电气工程师",       email: "shaohui.qian@gerrytech.com",  phone: "" },
  { employeeId: "GRT003", name: "倪亚琴",  department: "事业三部",   position: "采购与项目工程师", email: "yaqin.hou@gerrytech.com",     phone: "" },
  { employeeId: "GRT007", name: "孙坚",    department: "事业三部",   position: "电气主管",         email: "jian.sun@gerrytech.com",      phone: "" },
  { employeeId: "GRT055", name: "沈迎凤",  department: "事业三部",   position: "商务经理",         email: "yingfeng.shen@gerrytech.com", phone: "" },
  ...
  { employeeId: "GRT024", name: "张腾飞",  department: "事业四部",   position: "机加工班组长",     email: "pengfei.zhang@gerrytech.com", phone: "" },
  ...
  { employeeId: "GRT045", name: "杨勇",    department: "事业三部", position: "生产工程师兼项目经理", email: "yong.yang@gerrytech.com",     phone: "" },
];
...
async function main() {
  ...
  console.log("  ExternalSync Org Migration Script");
  console.log("  外部平台组织架构导入");
  console.log("=".repeat(60));
  console.log();
