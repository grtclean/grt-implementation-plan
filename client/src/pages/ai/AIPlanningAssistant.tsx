  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      setTasks([
        ...
        { id: '3', name: '机械设计', phase: 'M3', duration: 15, startDate: '2024-02-20', endDate: '2024-03-11', assignee: '王工', dependencies: ['2'], risk: 'medium' },
      ...
      setResources([
        { role: '机械工程师', name: '王工', utilization: 85, tasks: 3, overloaded: false },
