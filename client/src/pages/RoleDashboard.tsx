...
const roleQuickActions: Record<string, QuickAction[]> = {
  admin: [
    ...
    { label: "ERP集成", labelEn: "ERP", icon: Cog, link: "/admin/erp", color: "text-purple-500" },
  ...
  bu_gm: [
    ...
    { label: "团队管理", labelEn: "Team", icon: Users, link: "/bu/team", color: "text-green-500" },
    { label: "客户价值", labelEn: "Customer Value", icon: TrendingUp, link: "/customer-value", color: "text-orange-500" },
  ...
  bu_pm: [
    ...
    { label: "门径管理", labelEn: "Stage Gate", icon: Target, link: "/project-gate", color: "text-indigo-500" },
    { label: "生产执行", labelEn: "Production", icon: Wrench, link: "/production-execution", color: "text-green-500" },
    { label: "BOM管理", labelEn: "BOM", icon: Package, link: "/bom", color: "text-amber-500" },
  ...
  bu_sales: [
    ...
    { label: "AI报价", labelEn: "AI Quotation", icon: Zap, link: "/ai/quotation", color: "text-purple-500" },
    { label: "客户问卷", labelEn: "Questionnaire", icon: FileText, link: "/questionnaire", color: "text-orange-500" },
  ],
  bu_mech: [
    { label: "设计任务", labelEn: "Design Tasks", icon: Cog, link: "/tasks", color: "text-sky-500" },
    { label: "BOM查看", labelEn: "BOM View", icon: Package, link: "/bom", color: "text-amber-500" },
  ...
  procurement_eng: [
    ...
    { label: "仓库管理", labelEn: "Warehouse", icon: Package, link: "/warehouse", color: "text-blue-500" },
    { label: "供应商", labelEn: "Suppliers", icon: Building2, link: "/pos/procurement", color: "text-green-500" },
    { label: "库存预警", labelEn: "Stock Alert", icon: AlertTriangle, link: "/warehouse", color: "text-red-500" },
  ],
  cs_engineer: [
    { label: "服务工单", labelEn: "Service Orders", icon: Headphones, link: "/after-sales", color: "text-orange-500" },
    { label: "客户签收", labelEn: "Signature", icon: CheckCircle2, link: "/customer-signature", color: "text-green-500" },
  ...
  hr_manager: [
    { label: "人事管理", labelEn: "HR Management", icon: Users, link: "/employees", color: "text-pink-500" },
    { label: "绩效评估", labelEn: "Performance", icon: Target, link: "/performance", color: "text-indigo-500" },
  ...
  finance_manager: [
    { label: "成本管理", labelEn: "Cost", icon: BarChart3, link: "/cost", color: "text-blue-500" },
    { label: "预算管理", labelEn: "Budget", icon: Target, link: "/budget", color: "text-indigo-500" },
