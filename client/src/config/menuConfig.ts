...
export const menuConfig: MenuGroup[] = [
  ...
  // 二、市场与销售  // ────────────────────────────────────
  {
    ...
    items: [
      ...
      { name: "AI销售预测", nameEn: "AI Sales Forecast", path: "/ai-sales-forecast", icon: TrendingUp, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "bu_sales", "dept_manager"] },
      { name: "AI客户流失", nameEn: "AI Churn", path: "/ai-customer-churn", icon: UserCheck, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "bu_sales", "dept_manager"] },
      { name: "商机→需求转化", nameEn: "Opp Conversion", path: "/opportunity-conversion", icon: Target, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "bu_sales", "bu_pm", "dept_manager"] },
      { name: "评审→报价联动", nameEn: "Review→Quote", path: "/review-to-quotation", icon: FileCheck, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "bu_sales", "bu_pm", "dept_manager"] },
    ],
  },
  ...
  // 三、研发设计（TX-001~TX-005）  // ────────────────────────────────────
  {
    ...
    items: [
      ...
      { name: "AI设计审查", nameEn: "AI Design Review", path: "/ai-design-review", icon: Shield, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "bu_pm", "bu_mech", "bu_elec", "dept_manager"] },
      { name: "3D模型预览", nameEn: "3D Model Viewer", path: "/model-viewer-3d", icon: Box, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "bu_pm", "bu_mech", "bu_elec", "dept_manager"] },
      { name: "BOM校验", nameEn: "BOM Verification", path: "/bom-verification", icon: CheckCircle, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "bu_pm", "bu_mech", "bu_elec"] },
      { name: "BOM导入", nameEn: "BOM Import", path: "/bom-import", icon: Upload, isNew: true,
        allowedRoles: ["admin", "bu_pm", "bu_mech", "bu_elec"] },
      { name: "BOM Excel导入", nameEn: "BOM Excel Import", path: "/bom-excel-import", icon: Upload, isNew: true,
        allowedRoles: ["admin", "bu_pm", "bu_mech", "bu_elec"] },
    ],
  },
  ...
  // 四、项目管理  // ────────────────────────────────────
  {
    ...
    items: [
      ...
      { name: "POS连接器配置", nameEn: "POS Connectors", path: "/pos/connectors", icon: Cable, isNew: true,
        allowedRoles: ["admin", "bu_pm", "bu_mech", "bu_elec", "bu_sales"] },
      { name: "区域认证管理", nameEn: "Regional Cert", path: "/regional-certification", icon: Award, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "bu_pm", "dept_manager"], requiresBU: true },
      { name: "工作日计算器", nameEn: "Working Days", path: "/working-days-calculator", icon: CalendarDays, isNew: true },
    ],
  },
  ...
  // 五、生产制造（TX-006~TX-012）  // ────────────────────────────────────
  {
    ...
    items: [
      ...
      { name: "清洁度检测", nameEn: "Cleanliness QC", path: "/cleanliness-inspection", icon: ClipboardCheck, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "bu_pm", "bu_mech", "dept_manager"] },
      { name: "交接班记录", nameEn: "Shift Handover", path: "/shift-handover", icon: RefreshCw, isNew: true },
      { name: "SOP工艺卡片", nameEn: "SOP Process Card", path: "/sop-process-card", icon: FileText, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "bu_pm", "bu_mech", "bu_elec", "dept_manager"] },
      // Phase 21 P1: 质量高级
      { name: "AI产品合格证", nameEn: "Product Certificate", path: "/product-certificate", icon: FileCheck, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "bu_pm", "bu_mech", "dept_manager"] },
      { name: "SPC控制图", nameEn: "SPC Charts", path: "/spc-charts", icon: BarChart3, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "bu_pm", "bu_mech", "dept_manager"] },
      { name: "NCR不合格品", nameEn: "NCR Workflow", path: "/ncr-workflow", icon: AlertTriangle, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "bu_pm", "bu_mech", "dept_manager"] },
      // Phase 21 P1: 生产高级
      { name: "AI缺料预警", nameEn: "Shortage Alert", path: "/material-shortage-alert", icon: AlertTriangle, isNew: true },
      { name: "智能工位领料", nameEn: "Requisition", path: "/workstation-requisition", icon: Package, isNew: true },
      { name: "生产异常上报", nameEn: "Exception Report", path: "/production-exception-report", icon: AlertTriangle, isNew: true },
      { name: "AI生产日报", nameEn: "Daily Report", path: "/production-daily-report", icon: FileText, isNew: true },
      { name: "三套工时对账", nameEn: "Time Reconciliation", path: "/time-reconciliation", icon: Clock, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "bu_pm", "dept_manager"] },
      { name: "AI质量月报", nameEn: "Quality Monthly", path: "/quality-monthly-report", icon: BarChart3, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "bu_pm", "dept_manager"] },
      { name: "BOM冻结→排产", nameEn: "BOM Freeze", path: "/bom-freeze-automation", icon: Package, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "bu_pm", "dept_manager"] },
      { name: "工序进度", nameEn: "Production Steps", path: "/production-steps", icon: Wrench, isNew: true },
      { name: "生产执行视图", nameEn: "Production Execution", path: "/production-execution", icon: Factory, isNew: true },
      ...
      { name: "CCD集成", nameEn: "CCD Integration", path: "/ccd-integration", icon: Cpu, isNew: true,
        allowedRoles: ["admin", "bu_pm", "bu_mech", "bu_elec"] },
      { name: "CCD实时看板", nameEn: "CCD Realtime", path: "/ccd-realtime", icon: Monitor, isNew: true,
        allowedRoles: ["admin", "bu_pm", "bu_mech", "bu_elec"] },
      { name: "UWB设备管理", nameEn: "UWB Devices", path: "/production/uwb-devices", icon: MapPin, isNew: true,
        allowedRoles: ["admin"] },
  ...
  // 六、客户服务（TX-013~TX-015 + 售后）  // ────────────────────────────────────
  {
    ...
    items: [
      ...
      { name: "AI故障诊断", nameEn: "AI Fault Diagnosis", path: "/ai-fault-diagnosis", icon: Stethoscope, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "cs_engineer", "dept_manager"] },
      { name: "AI预防维护", nameEn: "AI Maintenance", path: "/ai-maintenance-plan", icon: Wrench, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "cs_engineer", "dept_manager"] },
      { name: "客户自助报修", nameEn: "Customer Repair", path: "/customer-repair", icon: Ticket, isNew: true },
      // Phase 21 P1: 服务高级
      { name: "AI远程支持", nameEn: "Remote Assist", path: "/remote-assistance", icon: Headphones, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "cs_engineer", "dept_manager"] },
      { name: "SLA分析仪表板", nameEn: "SLA Dashboard", path: "/service-sla", icon: Gauge, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "cs_engineer", "dept_manager"] },
      { name: "售后→设计反馈", nameEn: "Design Feedback", path: "/aftersales-design-feedback", icon: GitBranch, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "cs_engineer", "bu_pm", "bu_mech", "dept_manager"] },
      { name: "工单→知识库", nameEn: "Ticket→KB", path: "/ticket-to-kb", icon: BookOpen, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "cs_engineer", "dept_manager"] },
      { name: "NPS满意度调查", nameEn: "NPS Survey", path: "/nps-survey", icon: Star, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "cs_engineer", "dept_manager"] },
      { name: "QC终检→验收通知", nameEn: "QC→Acceptance", path: "/qc-pass-notification", icon: CheckCircle, isNew: true,
  ...
  // 七、人力资源  // ────────────────────────────────────
  {
    ...
    items: [
      ...
      { name: "中国劳动法合规", nameEn: "CN Labor Law", path: "/cn-labor-compliance", icon: Scale, isNew: true,
        allowedRoles: ["admin", "director", "dept_manager", "hr_manager", "hr_specialist"] },
      { name: "五险一金计算", nameEn: "Social Insurance", path: "/ai-social-insurance", icon: Calculator, isNew: true,
        allowedRoles: ["admin", "director", "dept_manager", "hr_manager", "hr_specialist"] },
      { name: "员工管理", nameEn: "Employee Mgmt", path: "/employee-management", icon: Users, isNew: true,
        allowedRoles: ["admin", "director", "hr_manager", "hr_specialist", "dept_manager"] },
      { name: "离职管理", nameEn: "Offboarding", path: "/offboarding", icon: UserCheck, isNew: true,
        allowedRoles: ["admin", "director", "hr_manager", "hr_specialist"] },
      ...
      { name: "薪资报表", nameEn: "Salary Report", path: "/salary-report", icon: FileText, isNew: true,
        allowedRoles: ["admin", "director", "hr_manager", "finance_manager"] },
      { name: "薪资审批", nameEn: "Salary Approval", path: "/salary-approval", icon: CheckCircle, isNew: true,
        allowedRoles: ["admin", "director", "hr_manager", "finance_manager"] },
      { name: "BU团队管理", nameEn: "BU Team Mgmt", path: "/bu-team-management", icon: Building2, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "dept_manager"] },
      { name: "用户状态管理", nameEn: "User Status", path: "/user-status-management", icon: UserCog, isNew: true,
        allowedRoles: ["admin", "hr_manager"] },
      { name: "来访申请", nameEn: "Visitor Request", path: "/visitor-request", icon: Users, isNew: true },
    ],
  },
  ...
  // 九、财务管理  // ────────────────────────────────────
  {
    ...
    items: [
      ...
      { name: "AI预算分析", nameEn: "AI Budget", path: "/ai-budget-analysis", icon: Wallet, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "finance_manager", "dept_manager"] },
      { name: "AI成本优化", nameEn: "AI Cost Opt", path: "/ai-cost-optimization", icon: Calculator, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "finance_manager"] },
      { name: "AI税费计算", nameEn: "AI VAT Calc", path: "/ai-vat-calculator", icon: Receipt, isNew: true,
        allowedRoles: ["admin", "director", "bu_gm", "finance_manager", "finance_specialist"] },
    ],
  },
  ...
  // 十二、系统管理（admin可见）  // ────────────────────────────────────
  {
    ...
    items: [
      ...
      { name: "ERP集成配置", nameEn: "ERP Config", path: "/admin/erp-configuration", icon: Database, isNew: true },
      { name: "ERP连接管理", nameEn: "ERP Connection", path: "/admin/erp-connection", icon: Cable, isNew: true },
